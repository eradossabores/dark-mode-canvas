      ...
      <Card className="w-full max-w-md shadow-2xl border-sky-200/50">
        <CardHeader className="text-center space-y-3">
          <div className="flex justify-center">
            <img src={logo} alt="D'PRAIA ICE" className="h-16 w-16 rounded-lg shadow-md"  loading="lazy" decoding="async" />
          </div>
        ...
        <CardContent>
          ...
          <p className="text-xs text-center text-muted-foreground mt-3">
            Ao usar o Google, sua conta será criada automaticamente.
          </p>
        </CardContent>
      </Card>
    </div>
