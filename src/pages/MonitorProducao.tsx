...
import { Monitor, Clock, User, Package, CalendarClock, MessageSquare, Maximize2, Minimize2, CheckCircle2, PackageCheck } from "lucide-react";
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-5">
                    ...
                    <div className="flex-1 space-y-4">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {urgency && (
                          <Badge className={`${urgency.className} text-sm px-3 py-1 font-bold`}>
                            ⚠ {urgency.label}
                          </Badge>
                        )}
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {pedido.pedido_producao_itens?.map((item: any) => (
                          <div
                            key={item.id}
                            className="bg-muted border border-border rounded-lg px-4 py-2 text-sm font-semibold flex items-center gap-2"
                          >
