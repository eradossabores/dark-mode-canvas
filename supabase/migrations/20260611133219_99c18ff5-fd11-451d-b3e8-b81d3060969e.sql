...
BEGIN
  ...
  LOOP
    ...
    SET forma_pagamento_tipo = 'aprazo',
        ...
        data_vencimento = COALESCE(data_vencimento, (v_venda.created_at::date + INTERVAL '7 days')::date)
    WHERE id = v_venda.id;
...
UPDATE public.clientes SET conversao_automatica_prazo = true WHERE conversao_automatica_prazo = false;
